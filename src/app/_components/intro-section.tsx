...
export default function IntroSection() {
  return (
    <section id="intro" className="space-y-6 py-8 md:py-12 lg:py-32 relative">
      {/* svg onde é adicionado no background */}
      <svg
      ...
      <div className="container flex max-w-[64rem] flex-col items-center text-center gap-4">
        ...
        <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">
          ...
          perferendis corporis eum molestias quae? Sunt saepe reiciendis, culpa
          eligendi ipsum vel ea exercitationem, sequi cum deserunt quae,
