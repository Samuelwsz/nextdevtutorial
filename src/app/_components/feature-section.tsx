    ...
    >
      <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
        ...
        <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
          ...
          temporibus repellat voluptates fuga consequuntur atque voluptatum
          delectus quaerat cumque impedit? Ut molestias dicta autem inventore
          incidunt fugit natus, sapiente nihil.
        </p>
      </div>
      ...
      <div className="mx-auto text-center md:max-w-[58rem]">
        <p className="leading-normal text-muted-foreground sm:text-lg sm:leading-7 mb-4">
          ...
          laboriosam ullam temporibus unde tempore. Odit voluptatibus voluptates
          ducimus in, nesciunt magnam esse, sit maiores quos quasi saepe
          cupiditate blanditiis quibusdam?
        </p>
